                      ...
                      @method('PUT')
                        <div class="row mb-3">
                          <label for="inputNumber" class="col-sm-2 col-form-label"  >Image</label>
                            <div class="col-sm-5">
                            <img src="{{asset("assets/admin/img/$data->image")}}" class="img-fluid" alt="Responsive image" alt="">
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                              <textarea class="form-control" style="height: 100px" name="content" value="{{$data->content}}"></textarea>
                            </div>
                        </div>
